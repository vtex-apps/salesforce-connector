...
describe('MasterDataService', () => {
  ...
  describe('saveUpdateOrder', () => {
    test('Save or update order in MTDT', async () => {
      ...
      const response = await service.saveUpdateOrder(
        order,
        'accountVtex',
        mockAxiosInstance
      )
  ...
  describe('saveUpdateParameter', () => {
    test('Save or update order in MTDT', async () => {
      ...
      const response = await service.saveUpdateParameter(
        parameter,
        'accountVtex',
        mockAxiosInstance
      )
  ...
  describe('saveUpdatePriceBookEntry', () => {
    test('Save or update priceBookEntry in MTDT', async () => {
      ...
      const response = await service.saveUpdatePriceBookEntry(
        priceBookEntry,
        'accountVtex',
        mockAxiosInstance
      )
  ...
  describe('getParameters', () => {
    test('get parameters from MTDT', async () => {
      ...
      const response = await service.getParameters(
        'accontVtex',
        mockAxiosInstance
      )
  ...
  describe('getPriceBookEntry', () => {
    test('get priceBookEntry from MTDT', async () => {
      jest
        .spyOn(mockAxiosInstance, 'get')
        .mockResolvedValue({ status: 200, data: [{}] })
      const response = await service.getPriceBookEntry(
        'id',
        'accontVtex',
        mockAxiosInstance
      )
